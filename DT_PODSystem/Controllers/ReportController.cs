    ...
    public class ReportController : Controller
    {
            ...
            try
            {
                ...
                var rawData = await query
                    ...
                    .Select(qr => new
                    {
                        ...
                        vendorName = qr.ProcessedFile.Template.Vendor != null ? qr.ProcessedFile.Template.Vendor.Name : "N/A",
        ...
        private async Task LoadFilterOptionsAsync(QueryResultReportViewModel viewModel)
        {
            ...
            var vendorData = await _context.QueryResults
                ...
                .ThenInclude(pf => pf.Template)
                .ThenInclude(t => t.Vendor)
                .Where(qr => qr.ProcessedFile.Template.Vendor != null)
                .Select(qr => new
                {
                    Id = qr.ProcessedFile.Template.Vendor!.Id,
                    Name = qr.ProcessedFile.Template.Vendor.Name
                })
                .Distinct()
                .OrderBy(v => v.Name)
                .ToListAsync();
            ...
            var departmentData = await _context.QueryResults
                ...
                .Select(qr => new
                {
                    Id = qr.ProcessedFile.Template.Department.Id,
                    DepartmentName = qr.ProcessedFile.Template.Department.Name,
                    GeneralDirectorateName = qr.ProcessedFile.Template.Department.GeneralDirectorate.Name
                })
                .Distinct()
